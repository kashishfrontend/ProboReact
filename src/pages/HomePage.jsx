        ...
        <div className="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" data-owl-options="{
          ...
          <div className="product product-2">
            ...
            <div className="product-body">
              ...
              <h3 className="product-title"><a href="/Product">Denim jacket</a></h3>{/* End .product-title */}
          ...
          <div className="product product-2">
            ...
            <div className="product-body">
              ...
              <h3 className="product-title"><a href="/Product">Sandals</a></h3>{/* End .product-title */}
              <div className="product-price">
                $24.99
              </div>{/* End .product-price */}
            </div>{/* End .product-body */}
          ...
          <div className="product product-2">
            ...
            <div className="product-body">
              ...
              <h3 className="product-title"><a href="/Product">Printed sweatshirt</a></h3>{/* End .product-title */}
              <div className="product-price">
          ...
          <div className="product product-2">
            ...
            <div className="product-body">
              ...
              <h3 className="product-title"><a href="/Product">Linen-blend paper bag trousers</a></h3>{/* End .product-title */}
              <div className="product-price">
                $17.99
              </div>{/* End .product-price */}
              <div className="product-nav product-nav-thumbs">
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">Tie-detail top</a></h3>{/* End .product-title */}
                  <div className="product-price">
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">Small bucket bag</a></h3>{/* End .product-title */}
                  <div className="product-price">
                    $14.99
                  </div>{/* End .product-price */}
                  <div className="product-nav product-nav-thumbs">
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">BShort wrap dress</a></h3>{/* End .product-title */}
                  <div className="product-price">
                    $17.99
                  </div>{/* End .product-price */}
                </div>{/* End .product-body */}
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">Biker jacket</a></h3>{/* End .product-title */}
                  <div className="product-price">
                    $34.99
                  </div>{/* End .product-price */}
                  <div className="product-nav product-nav-thumbs">
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">Loafers</a></h3>{/* End .product-title */}
                  <div className="product-price">
                    $9.99
                  </div>{/* End .product-price */}
                </div>{/* End .product-body */}
            ...
            <div className="col-6 col-md-4 col-lg-3">
              <div className="product product-2 text-center">
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title"><a href="/Product">Super Skinny High Jeggings</a></h3>{/* End .product-title */}
                  <div className="product-price">
