                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-6 col-md-4 col-lg-4">
                      <div className="product product-7 text-center">
                        ...
                        <div className="product-body">
                          ...
                          <div className="product-nav product-nav-thumbs">
                            <a href="#" className="active"><img src="assets/images/products/product-11-thumb.jpg" alt="product desc" /></a>
                            <a href="#"><img src="assets/images/products/product-11-2-thumb.jpg" alt="product desc" /></a>
                            <a href="#"><img src="assets/images/products/product-11-3-thumb.jpg" alt="product desc" /></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="col-6 col-md-4 col-lg-4">
                      <div className="product product-7 text-center">
                        ...
                        <div className="product-body">
                          <div className="product-cat"><a href="#">Jumpers</a></div>
